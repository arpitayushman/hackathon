...
api_key ="09b547978cbd4f32aa66a58a1d383894"
vanna_model_name = 'my-test-ana-model'
...
vn.connect_to_postgres(host='localhost', dbname='test', user='postgres', password='root', port='5432')
